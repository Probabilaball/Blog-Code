...
# Change 2022 or 2023 for the appropriate year

h <- read.csv('C:/Users/rcfos/Documents/GitHub/Blog-Code/2022-2023 Stabilization Points/2023 Hitting Data.csv',header=T)
p <- read.csv('C:/Users/rcfos/Documents/GitHub/Blog-Code/2022-2023 Stabilization Points/2023 Pitching Data.csv',header=T)
...
plot.stabilization.p <- function(M, se, lower.bound = 0.25, upper.bound = 0.75) {
  ...
  plot(p, n.est, type = 'l', lwd = 2, xlab = "Stabilization Level", ylab = "Required Number of Events", main = "Estimated Number of Events Required\nfor Given Stabilization Level")
  points(p,l, type= 'l', lty=2, lwd =2)
  points(p,u, type = 'l', lty=2, lwd = 2)
...
plot.stabilization.n <- function(M, se, lower.n = 1, upper.n = 600) {
  ...
  plot(n,p.est, type = 'l', lwd = 2, xlab = "Number of Events", ylab = "Estimated Stabilization Level", main = "Estimated Stabilization Level\nfor Given Number of Events",ylim = c(0,max(u)))
  points(n,l, type= 'l', lty=2, lwd = 2)
  points(n,u, type = 'l', lty=2, lwd = 2)
