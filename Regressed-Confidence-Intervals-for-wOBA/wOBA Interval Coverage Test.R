...
x.1 <- data.frame(d$X1B.1, d$X2B.1, d$X3B.1, d$HR.1, d$BB.1, d$HBP.1)
x.1 <- as.matrix(cbind(x.1, d$PA.1 - d$IBB.1 - apply(x.1, 1, sum)))

x.2 <- data.frame(d$X1B.2, d$X2B.2, d$X3B.2, d$HR.2, d$BB.2, d$HBP.2)
x.2 <- as.matrix(cbind(x.2, d$PA.2 - d$IBB.2 - apply(x.2, 1, sum)))
