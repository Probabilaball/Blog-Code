...
hist(x/n,freq=F, ylim = c(0, yMax), xlab = "ER/IP",ylab = "Density", main = "Observed Earned Run Rate with True Talent Distribution")
...
plot(p,c, type = 'l', xlab = "Stabilization Level", ylab = "Innings Pitched Required", main = "IP Required for Earned Run Rate Stabilization, 2009-2014")
